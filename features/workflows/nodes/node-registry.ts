...
export type NodeField = {
  ...
  label: string
  placeholder?: string
  // Renders as a textarea instead of a single-line input, for values that run
  // long or span several lines (a script, a prompt, a block of text).
  multiline?: boolean
  required?: boolean
}
...
export const nodeRegistry = {
  ...
  "open-url": {
    ...
    fields: [
      ...
      //   key: "description",
      //   label: "Description",
      //   placeholder: "A description of the URL",
      //   multiline: true,
      // },
    ],
  },
